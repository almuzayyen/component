...
], function (Opa5, Press, Common, EnterText,
  AggregationLengthEquals, AggregationFilled,
    ...
    onTheMasterPage: {
      ...
      actions: {
        ...
        iSortTheListOnName: function () {
          return this.iChooseASorter("sortButton",
            "Sort By <Name>");
        },
        ...
        iFilterTheListOnUnitNumber: function () {
          return this.iMakeASelection("filterButton",
            "<UnitNumber>", "<100 <UnitOfMeasure>");
        },

        iGroupTheList: function () {
          return this.iChooseASorter("groupButton",
            "<UnitNumber> Group");
        },
              ...
              this.waitFor({
                ...
                success: function () {
                  this.waitFor({
                    ...
                    errorMessage: "Did not find the" +
                      sOption + "in" +
                      sItem
                  });
                },
                errorMessage: "Did not find the " +
                  sItem + " element in select"
              });
            },
            errorMessage: "Did not find the " + sSelect +
              " select"
          });
        },
        ...
        iRememberTheIdOfListItemAtPosition: function (
          iPosition) {
          return this.waitFor({
            id: "list",
            viewName: sViewName,
            ...
            errorMessage: "The list does not have an item at the index " +
              iPosition
          });
        },
              ...
              this.waitFor({
                ...
                success: function (oList) {
                  ...
                  if (!aItemsNotInTheList.length) {
                    ...
                    sCurrentId = aEntityData[
                      aEntityData.length -
                      1].ObjectID;
                  } else {
                    sCurrentId =
                      aItemsNotInTheList[0].ObjectID;
                  }

                  var oCurrentItem = this.getContext()
                    .currentItem;
                  // Construct a binding path since the list item is not created yet and we only have the id.
                  oCurrentItem.bindingPath =
                    "/" + oList.getModel()
                    .createKey("Objects", {
                      ObjectID: sCurrentId
                    });
        ...
        iPressOnTheObjectAtPosition: function (iPositon) {
          return this.waitFor({
            ...
            actions: new Press(),
            errorMessage: "List 'list' in view '" +
              sViewName +
              "' does not contain an ObjectListItem at position '" +
              iPositon + "'"
          });
        },
        iSearchForTheFirstObject: function () {
          ...
          return this.waitFor({
            ...
            success: function (oList) {
              sFirstObjectTitle = oList.getItems()[0]
                .getTitle();
        ...
        iTypeSomethingInTheSearchThatCannotBeFoundAndTriggerRefresh: function () {
          return this.iSearchForValue(function (
            oSearchField) {
            oSearchField.setValue(
              sSomethingThatCannotBeFound);
      ...
      assertions: {
        ...
        theListShouldContainOnlyFormattedUnitNumbers: function () {
          ...
          return this.waitFor({
            ...
            success: function (aNumberControls) {
              Opa5.assert.ok(aNumberControls.every(
                  function (oNumberControl) {
                    return rTwoDecimalPlaces.test(
                      oNumberControl.getNumber());
                  }),
        ...
        theListHeaderDisplaysZeroHits: function () {
          return this.waitFor({
            ...
            success: function () {
              Opa5.assert.ok(true,
                "The list header displays zero hits"
              );
            },
        ...
        theListShouldNotContainGroupHeaders: function () {
          function fnIsGroupHeader(oElement) {
            return oElement.getMetadata()
              .getName() === "sap.m.GroupHeaderListItem";
          }
          ...
          return this.waitFor({
            ...
            matchers: function (oList) {
              return !oList.getItems()
                .some(fnIsGroupHeader);
            },
            success: function () {
              Opa5.assert.ok(true,
                "Master list does not contain a group header although grouping has been removed."
              );
            },
        ...
        theListShouldBeFilteredOnUnitNumber: function () {
          return this.theListShouldBeFilteredOnFieldUsingComparator(
            "UnitNumber", 100);
        },
        ...
        theListShouldBeFilteredOnFieldUsingComparator: function (
          sField, iComparator) {
          function fnCheckFilter(oList) {
            var fnIsFiltered = function (oElement) {
              if (!oElement.getBindingContext()) {
                ...
                var iValue = oElement.getBindingContext()
                  .getProperty(sField);
          ...
          return this.waitFor({
            ...
            success: function () {
              Opa5.assert.ok(true,
                "Master list has been filtered correctly for field '" +
                sField + "'.");
            },
            errorMessage: "Master list has not been filtered correctly for field '" +
              sField + "'."
          });
        },
        iShouldSeeTheList: function () {
          return this.waitFor({
            ...
            viewName: sViewName,
            success: function (oList) {
              Opa5.assert.ok(oList,
                "Found the object List");
            },
          ...
          this.waitFor({
            ...
            check: function (oList) {
              var sTitle = oList.getItems()[0].getTitle(),
                bEveryItemContainsTheTitle = oList.getItems()
            ...
            success: function (oList) {
              Opa5.assert.ok(true,
                "Every item did contain the title");
            },
        ...
        theListShouldHaveAllEntries: function () {
          ...
          return this.waitFor({
            ...
            matchers: function (oList) {
              ...
              iExpectedNumberOfItems = Math.min(oList
                .getGrowingThreshold(),
                aAllEntities.length);
            ...
            success: function (oList) {
              Opa5.assert.strictEqual(oList.getItems()
                .length, iExpectedNumberOfItems,
                "The growing list displays all items"
              );
            },
        ...
        theHeaderShouldDisplayAllEntries: function () {
          return this.waitFor({
            ...
            viewName: sViewName,
            success: function (oList) {
              var iExpectedLength = oList.getBinding(
                  "items")
                .getLength();
              this.waitFor({
                id: "masterPageTitle",
                ...
                success: function () {
                  Opa5.assert.ok(true,
                    "The master page header displays " +
                    iExpectedLength +
                    " items");
                },
                errorMessage: "The  master page header does not display " +
                  iExpectedLength + " items."
              });
            },
        ...
        theListShouldHaveNoSelection: function () {
          return this.waitFor({
            ...
            success: function (oList) {
              Opa5.assert.strictEqual(oList.getSelectedItems()
                .length, 0,
                "The list selection is removed");
            },
        ...
        theListShouldBeSortedAscendingOnField: function (
          ...
          function fnCheckSort(oList) {
            var oLastValue = null,
              fnSortByField = function (oElement) {
                ...
                var oCurrentValue = oElement.getBindingContext()
                  .getProperty(sField);
          ...
          return this.waitFor({
            ...
            success: function () {
              Opa5.assert.ok(true,
                "Master list has been sorted correctly for field '" +
                sField + "'.");
            },
            errorMessage: "Master list has not been sorted correctly for field '" +
              sField + "'."
          });
        }
      }
