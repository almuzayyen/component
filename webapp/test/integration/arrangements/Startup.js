sap.ui.define([
	"sap/ui/test/Opa5",
	"com/aramco/ZSCM_CT_COMPONENT/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.aramco.ZSCM_CT_COMPONENT.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.aramco.ZSCM_CT_COMPONENT",
					async: true
				},
				hash: oOptions.hash,
